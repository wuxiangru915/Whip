...
**Announce at start:** "I'm using the whip-execute skill to implement this plan."

**Note:** Tell your human partner that Superpowers works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use whip-subagent instead of this skill.
...
- Announce: "I'm using the whip-finish skill to complete this work."
- **REQUIRED SUB-SKILL:** Use whip-finish
...
- **whip-worktree** - Ensures isolated workspace (creates one or verifies existing)
- **whip-plan** - Creates the plan this skill executes
- **whip-finish** - Complete development after all tasks
