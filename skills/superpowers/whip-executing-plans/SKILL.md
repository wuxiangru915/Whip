...
**Announce at start:** "I'm using the whip-executing-plans skill to implement this plan."

**Note:** Tell your human partner that Superpowers works much better with access to subagents. The quality of its work will be significantly higher if run on a platform with subagent support (such as Claude Code or Codex). If subagents are available, use superpowers:whip-subagent-driven-development instead of this skill.
...
- Announce: "I'm using the whip-finishing-a-development-branch skill to complete this work."
- **REQUIRED SUB-SKILL:** Use superpowers:whip-finishing-a-development-branch
